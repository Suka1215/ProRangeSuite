...
function normalizeStoredShot(value: unknown, index = 0): Shot | null {
  ...
  return {
    ...
    pr: {
      ...
      clubHeadSpeedMph: asOptionalNumber(firstPresent(pr.clubHeadSpeedMph, pr.clubHeadSpeedMPH, value.clubHeadSpeedMph, value.clubHeadSpeedMPH, ball.ClubHeadSpeed, ball.clubHeadSpeed, ball.clubHeadSpeedMPH)),
      smashFactor: asOptionalNumber(firstPresent(pr.smashFactor, value.smashFactor, ball.SmashFactor)),
      spinAxisDeg: asOptionalNumber(firstPresent(pr.spinAxisDeg, value.spinAxisDeg, value.spinAxis, ball.SpinAxis, ball.spinAxis)),
      clubPathDeg: asOptionalNumber(firstPresent(pr.clubPathDeg, value.clubPathDeg, value.clubPath, value.clubPathDegrees, ball.ClubPath, ball.clubPath)),
      faceAngleDeg: asOptionalNumber(firstPresent(pr.faceAngleDeg, value.faceAngleDeg, value.faceAngle, value.faceDegrees, ball.FaceAngle, ball.faceAngle)),
      faceToPathDeg: asOptionalNumber(firstPresent(pr.faceToPathDeg, value.faceToPathDeg, value.faceToPath, value.faceToPathDegrees, ball.FaceToPath, ball.faceToPath)),
    },
    tm: tm
      ? {
          ...
          clubHeadSpeedMph: asOptionalNumber(firstPresent(tm.clubHeadSpeedMph, tm.clubHeadSpeedMPH)),
          smashFactor: asOptionalNumber(tm.smashFactor),
          spinAxisDeg: asOptionalNumber(firstPresent(tm.spinAxisDeg, tm.spinAxis)),
          clubPathDeg: asOptionalNumber(tm.clubPathDeg),
          faceAngleDeg: asOptionalNumber(tm.faceAngleDeg),
          faceToPathDeg: asOptionalNumber(tm.faceToPathDeg),
        }
      : null,
...
function shotToSessionShot(shot: Shot, idx: number): SessionShot {
  return {
    ...
    pr: {
      ...
      clubHeadSpeedMph: shot.pr.clubHeadSpeedMph,
      smashFactor: shot.pr.smashFactor,
      spinAxisDeg: shot.pr.spinAxisDeg,
      clubPathDeg: shot.pr.clubPathDeg,
      faceAngleDeg: shot.pr.faceAngleDeg,
      faceToPathDeg: shot.pr.faceToPathDeg,
    },
    tm: shot.tm ?? null,
